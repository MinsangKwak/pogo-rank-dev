    ...
    store = {
      ...
      users: {
        ...
        [adminUid]:    { email: 'admin@mock.local',  name: '로컬 테스트 (관리자)', favs: [150, 384, 383, 149, 68, 143, 302, 227, 25], roles: {},
          mons: [
            { id: 'mock-1', sprite: 6,   shadow: false, level: 43, ivs: [15, 15, 15], fast: '용의숨결', charged: '블라스트번', status: '육성 중',   memo: '', at: 1757400000000 },
            { id: 'mock-2', sprite: 9,   shadow: false, level: 28, ivs: [14, 15, 13], fast: '물대포',   charged: '하이드로캐논', status: '육성 중',   memo: '', at: 1757300000000 },
            { id: 'mock-3', sprite: 94,  shadow: true,  level: 20, ivs: [15, 15, 15], fast: '섀도클로', charged: '섀도볼',     status: '완료',     memo: '', at: 1757200000000 },
            ...
            { id: 'mock-6', sprite: 258, shadow: false, level: 20, ivs: [15, 15, 15], fast: '물대포',     charged: '머드샷',   status: '육성 중',   memo: '', at: 1756900000000 },
            { id: 'mock-7', sprite: 258, shadow: true,  level: 20, ivs: [15, 15, 15], fast: '물대포',     charged: '머드샷',   status: '교환 후보', memo: '', at: 1756800000000 },
          ] },
